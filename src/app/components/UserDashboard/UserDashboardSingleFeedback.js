            ...
            <div className="single-feedback">
                ...
                return (
                    <div className="single-feedback-message">
                        <i className="far fa-envelope"></i><h2 key={index}>{feedback.title}</h2><button onClick={(e) => this.markAsRead(feedback)} className="mark-as-read-btn"><i className="far fa-envelope-open"></i>Mark as read</button>
