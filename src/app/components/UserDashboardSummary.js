...
class UserDashboardSummary extends React.Component {
    ...
    getAveragePercentage() {
        ...
        let bassAvgPercentage = this.calculatePercentage(bassCompletedSongs, bassTotalSongs);
        let baritoneAvgPercentage = this.calculatePercentage(baritoneCompletedSongs, baritoneTotalSongs);
        let firstTenorAvgPercentage = this.calculatePercentage(firstTenorCompletedSongs, firstTenorTotalSongs);
        let secondTenorAvgPercentage = this.calculatePercentage(secondTenorCompletedSongs, secondTenorTotalSongs);
                ...
                <div className="container-full">
                    ...
                    <div className="col-lg-5 col-md-6 col-sm-12">
                        ...
                        <div className="part-container-header clearfix">
                            ...
                            <h5 className="col-lg-6">{this.state.bassAvgPercentage}%</h5>
                        </div>
                        ...
                        {this.state.users.map((user, index) => {
                            if(user.singingPart === 'Bass') {
                                return (
                                    <div key={index} className="col-lg-12 part-member">
                                        <div className="col-lg-2"><img className="part-member-avatar" src={user.profilePicURL} alt=""/></div>
                                        <div className="col-lg-6">{user.firstName} {user.lastName}</div>
                                        <div className="col-lg-4">{user.percentage}%</div>
                    ...
                    <div className="col-lg-5 col-md-6 col-sm-12">
                        ...
                        <div className="part-container-header clearfix">
                            ...
                            <h5 className="col-lg-6">{this.state.secondTenorAvgPercentage}%</h5>
                        </div>
                        <div className="part-table">
                            <div className="col-lg-8">Name</div>
                            <div className="col-lg-4">Percentage</div>
                    ...
                    <div className="col-lg-5 col-md-6 col-sm-12">
                        ...
                        <div className="part-container-header clearfix">
                            ...
                            <h5 className="col-lg-6">{this.state.firstTenorAvgPercentage}%</h5>
                        </div>
                        <div className="part-table">
                            <div className="col-lg-8">Name</div>
                            <div className="col-lg-4">Percentage</div>
                    ...
                    <div className="col-lg-5 col-md-6 col-sm-12">
                        ...
                        <div className="part-container-header clearfix">
                            ...
                            <h5 className="col-lg-6">{this.state.baritoneAvgPercentage}%</h5>
                        </div>
                        <div className="part-table">
                            <div className="col-lg-8">Name</div>
                            <div className="col-lg-4">Percentage</div>
